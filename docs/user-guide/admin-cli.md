...
When DS is set to _ALL_DS, access to any other datastore which has not been granted access to explicitly is allowed for vms in vmgroup.
Sample:
...
```
For _VM_DS and _ALL_DS special DS names, --volume-totalzie can also be set.
